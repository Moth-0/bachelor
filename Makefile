...
sweep_S : deu scripts/sweep_S.py Makefile
	...
	--S_min 30.8 --S_max 31.1 --S_steps 10 --jobs 10
...
contour_b_range : deu scripts/contour_plot_b_range.py Makefile
	...
	--S_init_anchor 25.0 --S_window 5.0 \
	--b_form $(B_FORM) --S_steps 4 --jobs 8
...
contour_b_rel : deu scripts/contour_b_rel.py Makefile
	python3 scripts/contour_b_rel.py --b_range_min 2.0 --b_range_max 2.5 --b_range_steps 10 \
	--S_init_anchor 30.0 --S_window 5.0 \
	--b_form $(B_FORM) --S_steps 4 --jobs 8
